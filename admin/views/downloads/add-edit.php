...
<tr id="file_upload_row" class="source-row file-source">
    ...
    <td>
		...
		<?php if ($is_edit): ?>
    <!-- Shortcode Section -->
    <div class="wcl-shortcode-section">
        <h3><?php _e('Shortcode', 'wcl'); ?></h3>
        <div class="wcl-shortcode-container">
            <p><?php _e('Use this shortcode to display the download:', 'wcl'); ?></p>
            <div class="wcl-shortcode-display">
                <code>[wcl_protected_download id="<?php echo esc_attr($download_id); ?>"]</code>
                <button type="button" class="button wcl-copy-shortcode">
                    <span class="dashicons dashicons-clipboard"></span>
                    <?php _e('Copy Shortcode', 'wcl'); ?>
                </button>
            </div>
        </div>
    </div>
...
jQuery(document).ready(function($) {
    ...
    $('.wcl-copy-shortcode').on('click', function() {
        ...
        try {
            ...
            $button.html('<span class="dashicons dashicons-yes"></span> <?php _e("Copied!", "wcl"); ?>');
